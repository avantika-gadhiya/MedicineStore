...
class StoreDetailResponse {
    ...
    inner class Data {
        ...
        @SerializedName("gst_verify_status")
        @Expose
        var gstVerifyStatus: String? = null

        @SerializedName("drug_license_image")
        @Expose
        var drugLicenseImage: String? = null

        @SerializedName("dl_verify_status")
        @Expose
        var dlCerifyStatus: String? = null
        ...
        @SerializedName("payment_method_array")
        @Expose
        var paymentMethodArray: List<PaymentMethodArray>? = null


        inner class PaymentMethodArray {
            @SerializedName("id")
            @Expose
            var id: String? = null
