...
import kotlinx.android.synthetic.main.activity_upload_drug_license.btn_next
import kotlinx.android.synthetic.main.activity_upload_drug_license.img_back
import kotlinx.android.synthetic.main.activity_upload_drug_license.img_upload_drug_lic
import kotlinx.android.synthetic.main.activity_upload_drug_license.txt_skip
import java.io.File

class UploadDrugLicenseActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_upload_drug_license)
    ...
    override fun onClick(v: View?) {
        ...
        when (v?.id) {
            ...
            R.id.txt_skip -> {
                startActivity(
                    Intent(
                        this@UploadDrugLicenseActivity,
                        UploadStorePhotoActivity::class.java
                    )
                )
...
//                    bitmap = BitmapFactory.decodeFile(path)
                    ...
                    drugLicense  = AppConstant.convert(bitmap!!)
                }
            }
        }
    }
