...
import bluesharklabs.com.medicinestore.activities.MainActivity
import bluesharklabs.com.medicinestore.interfaces.RetrofitInterface
import bluesharklabs.com.medicinestore.model.Verification
import bluesharklabs.com.medicinestore.response.VerificationResponse
import bluesharklabs.com.medicinestore.utills.AppConstant
import bluesharklabs.com.medicinestore.utills.AppConstant.CONSTANT_NUMBER
...
class Verify1Activity : AppCompatActivity(), View.OnClickListener {
           ...
           auth.signInWithCredential(credential)
               .addOnCompleteListener(this) { task ->
                   if (task.isSuccessful) {
                       ...
                       startActivity(Intent(this@Verify1Activity, StoreInfoActivity::class.java))
                       finish()
   ...
   */
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            R.id.img_back -> {
                startActivity(Intent(this@Verify1Activity, PersonalInfoActivity::class.java))
                finish()
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left)
            }
            R.id.btn_verify -> {
                ...
                if (stringBuilder.toString().length < 6 || !stringBuilder.toString().equals(otp)) {
                    ...
                    // verificationApi(stringBuilder.toString())
                    // verifyPhoneNumberWithCode(storedVerificationId, stringBuilder.toString())
                    startActivity(Intent(this@Verify1Activity, StoreInfoActivity::class.java))
                    finish()
                    overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left)
    ...
    fun verificationApi(number: String) {
