package bluesharklabs.com.medicinestore.adapters
...
import bluesharklabs.com.medicinestore.activities.CustomOrderDetailActivity
import bluesharklabs.com.medicinestore.activities.CustomViewOfferActivity
import bluesharklabs.com.medicinestore.activities.OrderDetailActivity
import bluesharklabs.com.medicinestore.activities.ViewOfferActivity
...
class MyOrdersAdapter(var context: Context, var myorder: List<ViewAllStoreOrderResponse.Datum>
    ...
    override fun onBindViewHolder(holder: MyOrdersAdapter.MyHolder, position: Int) {
      ...
      holder.txt_delivery_date.text = myorder.get(position).todate_fromdate
      ...
      holder.txt_percentage.text = myorder.get(position).discountPercentage+" % OFF"
        ...
        val category: String =  myorder.get(position).todate_fromdate.toString()
