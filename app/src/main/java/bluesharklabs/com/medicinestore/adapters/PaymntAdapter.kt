...
import bluesharklabs.com.medicinestore.response.GetAllDropdownResponse
...
class PaymntAdapter(
        ...
        var arrapaymnt: arrayPayment, var qrImg: addQRCode) : RecyclerView.Adapter<PaymntAdapter.MyHolder>() {
    ...
    override fun onBindViewHolder(holder: PaymntAdapter.MyHolder, pos: Int) {
        ...
        holder.checkBox.setOnCheckedChangeListener { buttonView, isChecked ->
            ...
            if (isChecked) {
                ...
                } else if (AppConstant.getPreferenceText(AppConstant.QR_CODE).equals(null) || AppConstant.getPreferenceText(AppConstant.QR_CODE).equals("")) {
